...
<template>
  <wxc-tab-bar :tab-titles="tabTitles"
    ...
    <div class="item-container" :style="contentStyle"><p>Home</p></div>
    
    <!--The second page content-->
    <div class="item-container" :style="contentStyle"><p>Hot</p></div>
    
    <!-- The third page content-->
    <div class="item-container" :style="contentStyle"><p>Message</p></div>
    
    <!-- The fourth page content-->
    <div class="item-container" :style="contentStyle"><p>My</p></div>
  </wxc-tab-bar>
</template>
